...
var send = function () {
    ...
    if (params.codigo == '2654321' && params.nip == '1234562') {
        var name = "Juan Jose Macias";
        var center = "CUCEI";
        var career = "COM";
        var queryString = "?code=" + params.codigo + "&name=" + name + "&center=" + center + "&career=" + career;
        window.location = "coordinadorView.html" + queryString;
    } else {
